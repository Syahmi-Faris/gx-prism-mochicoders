...
export function TopBar() {
  ...
  const notifications = [
    { id: "n1", title: "Impulse intercepted", body: `RM ${recoveryPocket} redirected to Recovery Pocket.`, time: "Just now" },
    { id: "n2", title: "New insight", body: "Late-night spend pattern detected on weekends.", time: "2h ago" },
    { id: "n3", title: "Streak going strong", body: "7-day resilience streak — keep it up!", time: "Today" },
  ];
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="w-[320px]">
            ...
            <div className="mt-4 space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground pt-2">{captured.length} captured items today</p>
            </div>
          </SheetContent>
        </Sheet>
        <Link
